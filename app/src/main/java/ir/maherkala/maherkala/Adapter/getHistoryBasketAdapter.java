...
import ir.maherkala.maherkala.Activity.HistoryItemBasketActivity;
...
//            }
            ...
            if (isEven(myViewHolder.getLayoutPosition())) {
                ...
                myViewHolder.cardview.setBackgroundColor(ContextCompat.getColor(context, R.color.light_orange));
            }
