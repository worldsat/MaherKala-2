...
import ir.maherkala.maherkala.Adapter.getSearchAdapter;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                ad = new getSearchAdapter(context, ImageItems, DiscountItems, IdItems, DescriptionItems, NameItems, PriceItems, TextItems, QuantityItems, LikeItems, TotalVotesItems, TotalCommentItems, OtherItems, ThumbnailItems, Intent, "", "", recyclerViewlist);
